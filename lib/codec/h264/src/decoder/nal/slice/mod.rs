use crate::decoder::nal::pps;
use crate::decoder::nal::pps::{PicParamSetId, PicParameterSet};
use crate::decoder::nal::sps;
use crate::decoder::nal::sps::SeqParameterSet;
use crate::decoder::nal::NalHeader;
use crate::decoder::rbsp::BitRead;
use crate::decoder::rbsp::BitReaderError;
use crate::decoder::Context;
...
impl DecRefPicMarking {
    fn read<R: BitRead>(
        ...
        Ok(
            if header.nal_unit_type() == crate::decoder::nal::UnitType::SliceLayerWithoutPartitioningIdr {
...
impl SliceHeader {
    pub fn from_bits<'a, R: BitRead>(
        ...
        let ref_pic_list_modification = if header.nal_unit_type()
            == crate::decoder::nal::UnitType::SliceExtension
            || header.nal_unit_type() == crate::decoder::nal::UnitType::SliceExtensionViewComponent
        {
...
mod test {
    use super::*;
    use crate::decoder::nal::{Nal, RefNal};
    use hex_literal::hex;

    #[test]
    fn invalid_num_ref_idx() {
        // Examples from fuzz testing.
        let mut ctx = crate::decoder::Context::default();
        let sps = RefNal::new(
